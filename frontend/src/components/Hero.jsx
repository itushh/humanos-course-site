...
const Hero = () => {
  return (
    <div className="md:mt-40 -mb-80 md:mb-0 w-full scale-30 sm:scale-40 md:scale-50 lg:scale-75 xl:scale-90 flex justify-center">
      <div className="font-jomhuria w-fit mx-auto dark:text-primary/90 relative">
        <h2 className="text-left text-7xl pl-4">Bring</h2>
        <h2 className="text-[700px] -mt-82 -mb-108 text-transparent dark:text-primary/90 [-webkit-text-stroke:2px_black]">PEACE</h2>
